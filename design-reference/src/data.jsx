...
// Tailwind color tokens for badges (muted, legible in both modes)
...
const REGIONS = ['台灣','中國','香港','日本','韓國','新加坡','亞太','美國','歐洲','全球'];

const IMPORTANCE = { high: { zh: '高', cls: 'text-red-600 dark:text-red-400' }, mid: { zh: '中', cls: 'text-amber-600 dark:text-amber-400' }, low: { zh: '低', cls: 'text-slate-500 dark:text-slate-400' } };

// Articles — mix of the 6 user-provided + extras to fill a 12-card grid
const ARTICLES = [
  {
    id: 'a1',
...
// Wiki tree
const WIKI_TREE = [
  { id: 'market', icon: '📈', zh: '市場趨勢', children: [
    { id: 'market-apac', zh: '亞太' },
    { id: 'market-global', zh: '全球' },
    { id: 'market-tw', zh: '台灣' },
  ]},
  { id: 'regulation', icon: '📋', zh: '監管動態', children: [
    { id: 'reg-tw', zh: '台灣' },
    { id: 'reg-hk', zh: '香港' },
    { id: 'reg-cn', zh: '中國' },
  ]},
  { id: 'tech', icon: '🔬', zh: '科技應用', children: [
    { id: 'tech-ai', zh: 'AI / LLM' },
    { id: 'tech-claims', zh: '理賠自動化' },
  ]},
  { id: 'esg', icon: '🌱', zh: 'ESG 永續', children: [
  ...
  { id: 'people', icon: '👥', zh: '人才與組織', children: [
...
Object.assign(window, {
  CATEGORIES, CATEGORY_COLORS, REGIONS, IMPORTANCE, ARTICLES,
  WIKI_TREE, WIKI_PAGE, CHAT_HISTORY_SEED,
});
